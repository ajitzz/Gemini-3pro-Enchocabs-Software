                        ...
                        <div key={d.id} className="p-4 bg-white hover:bg-slate-50 transition-colors">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                {hasChanges && (
                                    <button 
                                        onClick={() => saveDriverDefaults(d.id)}
                                        className="inline-flex items-center gap-1.5 text-xs font-bold bg-indigo-600 text-white px-3 py-1.5 rounded-lg hover:bg-indigo-700 shadow-md shadow-indigo-500/20 transition-all active:scale-95"
                                    >
                                        <Save size={14} /> Save
                                    </button>
                                )}
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="flex flex-col gap-1">
                                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">QR Code</span>
                                    <div className="relative">
                                        <select 
                                            value={displayQr} 
                                            onChange={e => handleEditChange(d.id, 'qrCode', e.target.value)}
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button onClick={() => setShowShiftHistory(d.id)} className="text-slate-400 hover:text-indigo-600 p-2 rounded-lg hover:bg-indigo-50 transition-colors border border-slate-200" title="View History">
                                            <History size={16} />
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <input 
                                        ...
                                        placeholder="0"
                                        onChange={e => handleEditChange(d.id, 'defaultRent', parseFloat(e.target.value))}
                                        className="w-full px-3 py-2 bg-slate-50 border-0 ring-1 ring-slate-200 rounded-lg text-sm font-medium focus:ring-2 focus:ring-indigo-500 outline-none"
                                    />
                                </div>
                            </div>
                        </div>
