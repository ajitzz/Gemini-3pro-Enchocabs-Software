    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans pb-24">
       {showNetPayoutPopup && netPayoutDetails && (
           ...
           >
               ...
               <div
                   className="relative w-full max-w-[420px] sm:max-w-[540px] h-[78vh] max-h-[90vh] rounded-[28px] shadow-2xl border border-slate-100/80 bg-gradient-to-b from-white via-slate-50 to-white overflow-hidden ring-1 ring-slate-100"
                   onClick={(e) => e.stopPropagation()}
               >
                   <div className="absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r from-indigo-500 via-violet-500 to-fuchsia-500" />
                   <div className="flex items-start justify-between px-5 sm:px-6 py-4 border-b border-slate-100 bg-white/90 backdrop-blur">
                   ...
                   <div className="absolute inset-0 top-[64px] bottom-0 flex flex-col">
                       <div className="flex-1 overflow-y-auto px-5 sm:px-6 pb-6 pt-4 space-y-4 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
