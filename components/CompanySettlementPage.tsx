                            ...
                            <div key={i} className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm space-y-4">
                                <div className="flex justify-between items-center border-b border-slate-50 pb-3">
                                    <div className="flex items-center gap-2">
                                        <div className="w-8 h-8 rounded-lg bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-xs">
                                            {row.vehicleNumber.slice(-4)}
                                        </div>
                                        <span className="font-bold text-slate-800">{row.vehicleNumber}</span>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[10px] uppercase font-bold text-slate-400">Current O/S</p>
                                        <p className="text-sm font-bold text-slate-900">₹{row.currentOs.toFixed(2)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-3">
                                        <div>
                                            <p className="text-[10px] uppercase font-bold text-slate-400">Lease Details</p>
                                            <div className="mt-1 space-y-1">
                                                <div className="flex justify-between text-xs">
                                                    <span className="text-slate-500">Onroad Days:</span>
                                                    <span className="font-medium">{row.onroadDays}</span>
                                                </div>
                                                <div className="flex justify-between text-xs">
                                                    <span className="text-slate-500">Rent Applied:</span>
                                                    <span className="font-medium">₹{row.dailyRentApplied}</span>
                                                </div>
                                                <div className="flex justify-between text-xs font-bold text-indigo-600 pt-1 border-t border-slate-50">
                                                    <span>Net Lease:</span>
                                                    <span>₹{row.netWeeklyLeaseRental.toFixed(2)}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <p className="text-[10px] uppercase font-bold text-slate-400">Uber Stats</p>
                                            <div className="mt-1 space-y-1">
                                                <div className="flex justify-between text-xs">
                                                    <span className="text-slate-500">Trips:</span>
                                                    <span className="font-medium">{row.uberTrips}</span>
                                                </div>
                                                <div className="flex justify-between text-xs">
                                                    <span className="text-slate-500">Earnings:</span>
                                                    <span className="font-medium text-emerald-600">₹{row.totalEarning.toFixed(2)}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            <p className="text-[10px] uppercase font-bold text-slate-400">Deductions</p>
                                            <div className="mt-1 space-y-1">
                                                <div className="flex justify-between text-xs">
                                                    <span className="text-slate-500">Cash Coll:</span>
                                                    <span className="font-medium text-rose-600">₹{row.uberCashCollection.toFixed(2)}</span>
                                                </div>
                                                <div className="flex justify-between text-xs">
                                                    <span className="text-slate-500">Sub Charge:</span>
                                                    <span className="font-medium text-rose-600">₹{row.driverSubscriptionCharge.toFixed(2)}</span>
                                                </div>
                                                <div className="flex justify-between text-xs font-bold text-indigo-600 pt-1 border-t border-slate-50">
                                                    <span>Wallet O/S:</span>
                                                    <span>₹{row.uberWeekOs.toFixed(2)}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            ...
                                            <div className="mt-1 space-y-1">
                                                <div className="flex justify-between text-xs">
                                                    ...
                                                    <span className="font-medium text-rose-500">₹{row.challan}</span>
                                                </div>
                                                <div className="flex justify-between text-xs">
                                                    <span className="text-slate-500">Accident:</span>
                                                    <span className="font-medium text-rose-500">₹{row.accident}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                {isEditingSummary && (
                                    <div className="pt-3 border-t border-slate-100 flex flex-wrap gap-2">
                                        <button onClick={() => alert("Please use desktop for bulk editing. Mobile editing is coming soon.")} className="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-3 py-1.5 rounded-lg">
                                            Quick Edit
                                        </button>
                                    </div>
                                )}
