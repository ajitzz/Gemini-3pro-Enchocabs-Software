...
export const storageService = {
  ...
  getHeaderMappings: async (): Promise<HeaderMapping[]> => {
    ...
    return data.length ? data : [
      { internalKey: 'vehicleNumber', label: 'Vehicle Number', excelHeader: 'Vehicle Number', required: true, calc: '' },
      { internalKey: 'onroadDays', label: 'Onroad Days', excelHeader: 'Onroad Days', required: true, calc: '+' },
      { internalKey: 'dailyRentApplied', label: 'Daily Rent Applied', excelHeader: 'Daily Rent Applied', required: true, calc: '+' },
      { internalKey: 'weeklyIndemnityFees', label: 'Weekly Indemnity Fees', excelHeader: 'Weekly Indemnity Fees', required: true, calc: '+' },
      { internalKey: 'netWeeklyLeaseRental', label: 'Net Weekly Lease Rental', excelHeader: 'Net Weekly Lease Rental', required: true, calc: '+' },
      { internalKey: 'performanceDay', label: 'Performance Day', excelHeader: 'Performance Day', required: false, calc: '' },
      { internalKey: 'uberTrips', label: 'Uber Trips', excelHeader: 'Uber Trips', required: true, calc: '+' },
      { internalKey: 'totalEarning', label: 'Total Earning', excelHeader: 'Total Earning', required: true, calc: '+' },
      { internalKey: 'uberCashCollection', label: 'Uber Cash Collection', excelHeader: 'Uber Cash Collection', required: true, calc: '-' },
      { internalKey: 'toll', label: 'Toll', excelHeader: 'Toll', required: true, calc: '-' },
      { internalKey: 'driverSubscriptionCharge', label: 'Driver Subscription Charge', excelHeader: 'Driver subscription charge', required: true, calc: '-' },
      { internalKey: 'uberIncentive', label: 'Uber Incentive', excelHeader: 'Uber Incentive', required: true, calc: '+' },
      { internalKey: 'uberWeekOs', label: 'Uber Week O/s', excelHeader: 'Uber Week O/s', required: true, calc: '+' },
      { internalKey: 'olaWeekOs', label: 'OLA Week O/s', excelHeader: 'OLA Week O/s', required: false, calc: '' },
      { internalKey: 'vehicleLevelAdjustment', label: 'Vehicle Level Adjustment', excelHeader: 'Vehicle Level Adjustment', required: true, calc: '+' },
      { internalKey: 'tds', label: 'TDS', excelHeader: 'TDS', required: true, calc: '-' },
      { internalKey: 'challan', label: 'Challan', excelHeader: 'Challan', required: true, calc: '-' },
      { internalKey: 'accident', label: 'Accident', excelHeader: 'Accident', required: true, calc: '-' },
      { internalKey: 'deadMile', label: 'DeadMile', excelHeader: 'DeadMile', required: true, calc: '-' },
      { internalKey: 'currentOs', label: 'Current O/S', excelHeader: 'Current O/S', required: true, calc: '+' },
    ];
  },
